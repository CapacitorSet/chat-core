...
// todo: verificare se il nick è valido
    ...
    JOIN: function(user, channelNames) {
        ...
        // todo: is channelname valid? "join #" currently results in a crash.
    ...
    KICK: function(user, channel, username, kickMessage) {
        ...
        // todo: for some reason, "kick #a giulio" results in  PRIVMSG #a :KICK.
        ...
        if (!targetUser) {
            ...
            if (channel.perms[user.username] < 2) {
                ...
                console.log(channel.perms, username);
        ...
        channel.rawSend(user.mask, 'KICK', channel.name, targetUser.username, kickMessage);
    ...
    INVITE: function(user, username, channelName) {
        ...
        channel.invite(targetUser.username);
    },
